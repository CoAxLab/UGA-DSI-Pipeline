...
for subjID in os.listdir(sourceDirectoryBids):
    ...
    for ses in os.listdir(subDir):
        ...
        qcCommand = f'{singularityCommand} mriqc /BIDS /QCOutput participant --participant_label {subjectSTR} --session-id {sessionSTR} --nprocs 48 --mem-gb 62 -w /work/{subjID}_{ses}'
