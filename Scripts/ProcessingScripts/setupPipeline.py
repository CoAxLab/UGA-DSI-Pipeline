...
allSetupPaths.append(os.path.join(pipelineDirectory, 'Data', 'AnalysisData', 'BIDS'))
allSetupPaths.append(os.path.join(pipelineDirectory, 'Data', 'AnalysisData', 'Derivatives'))
allSetupPaths.append(os.path.join(pipelineDirectory, 'Data', 'AnalysisData', 'Derivatives', 'fib'))
allSetupPaths.append(os.path.join(pipelineDirectory, 'Data', 'IntermediateData', 'src'))
